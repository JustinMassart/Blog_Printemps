						...
						<div class="mt-6">
							<form action="/"
								...
								<label for="post-title"
									   class="block <?= isset( $_SESSION[ 'errors' ][ 'post-title' ] ) ? ' text-red-600' : '' ?> mb-2">Post Title</label>
								<?= isset( $_SESSION[ 'errors' ][ 'post-title' ] ) ? '<p class="italic text-red-600">' . $_SESSION[ 'errors' ][ 'post-title' ] . '</p>' : '' ?>
								<input id="post-title"
									   type="text"
									   name="post-title"
								       <?php if ( isset( $_SESSION[ 'old' ][ 'post-title' ] ) ): ?>value="<?= $_SESSION[ 'old' ][ 'post-title' ] ?>"<?php endif ?>
								...
								<label for="post-excerpt"
									   class="block <?= isset( $_SESSION[ 'errors' ][ 'post-excerpt' ] ) ? ' text-red-600' : '' ?> mt-8 mb-2">Post Excerpt</label>
								<?= isset( $_SESSION[ 'errors' ][ 'post-excerpt' ] ) ? '<p class="italic text-red-600">' . $_SESSION[ 'errors' ][ 'post-excerpt' ] . '</p>' : '' ?>
								<textarea name="post-excerpt"
										  id="post-excerpt"
										  rows="5"
										  class="w-full rounded-md<?= isset( $_SESSION[ 'errors' ][ 'post-excerpt' ] ) ? ' border-red-600  accent-red-600' : ' border-gray-300' ?>  shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"><?php if ( isset( $_SESSION[ 'old' ][ 'post-excerpt' ] ) ): ?><?= $_SESSION[ 'old' ][ 'post-excerpt' ] ?><?php endif ?></textarea>

								<label for="post-body"
									   class="block <?= isset( $_SESSION[ 'errors' ][ 'post-body' ] ) ? ' text-red-600' : '' ?> mt-8 mb-2">Post Body</label>
								<?= isset( $_SESSION[ 'errors' ][ 'post-body' ] ) ? '<p class="italic text-red-600">' . $_SESSION[ 'errors' ][ 'post-body' ] . '</p>' : '' ?>
								<textarea name="post-body"
										  id="post-body"
										  rows="10"
										  class="w-full rounded-md<?= isset( $_SESSION[ 'errors' ][ 'post-body' ] ) ? ' border-red-600  accent-red-600' : ' border-gray-300' ?>  shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"><?php if ( isset( $_SESSION[ 'old' ][ 'post-body' ] ) ): ?><?= $_SESSION[ 'old' ][ 'post-body' ] ?><?php endif ?></textarea>

								<label for="post-category"
									   class="block <?= isset( $_SESSION[ 'errors' ][ 'post-category' ] ) ? ' text-red-600' : '' ?> mt-8 mb-2">Post Category</label>
								<?= isset( $_SESSION[ 'errors' ][ 'post-category' ] ) ? '<p class="italic text-red-600">' . $_SESSION[ 'errors' ][ 'post-category' ] . '</p>' : '' ?>
